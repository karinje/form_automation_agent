form_mapping = {
    ...
    "home_address.state_na": "ctl00_SiteContentPlaceHolder_FormView1_cbAPP_ADDR_STATE_NA",
    ...
    # Mailing Address (shown if mail_address_same_as_home = N)
    ...
    "phone.mobile_na": "ctl00_SiteContentPlaceHolder_FormView1_cbexAPP_MOBILE_TEL_NA",
    "phone.work": "ctl00_SiteContentPlaceHolder_FormView1_tbxAPP_BUS_TEL",
    "phone.work_na": "ctl00_SiteContentPlaceHolder_FormView1_cbexAPP_BUS_TEL_NA",
    
    # Additional Phone
    "add_phone": "ctl00_SiteContentPlaceHolder_FormView1_rblAddPhone",
    "additional_phone_number.add_phone_number": "ctl00_SiteContentPlaceHolder_FormView1_dtlAddPhone_ctl00_tbxAddPhoneInfo",
    ...
    "additional_email_address.add_email_address": "ctl00_SiteContentPlaceHolder_FormView1_dtlAddEmail_ctl00_tbxAddEmailInfo",
    ...
    "additional_social_media.add_platform": "ctl00_SiteContentPlaceHolder_FormView1_dtlAddSocial_ctl00_tbxAddSocialPlat",
    "additional_social_media.add_handle": "ctl00_SiteContentPlaceHolder_FormView1_dtlAddSocial_ctl00_tbxAddSocialHand",
