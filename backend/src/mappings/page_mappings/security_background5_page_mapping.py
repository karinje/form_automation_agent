form_mapping = {
    ...
    "exchange_visitor": "ctl00_SiteContentPlaceHolder_FormView1_rblExchangeVisitor",
    "exchange_visitor_explanation": "ctl00_SiteContentPlaceHolder_FormView1_tbxExchangeVisitor"
} 